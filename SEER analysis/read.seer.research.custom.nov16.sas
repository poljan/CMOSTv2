...
data in;                                                                              
  ...
  input                                                                               
    ...
    @ 363 RADIATNR             $char1.  /* Radiation Recode */
    @ 364 RAD_BRNR             $char1.  /* Radiation to Brain or CNS Recode (1988-1997) */
    @ 365 RAD_SURG             $char1.  /* Radiation sequence with surgery */
    @ 366 CHEMO_RX_REC         $char1.  /* Chemotherapy recode (yes, no/unk) */ ;                                                                