...
function handles = CMOSTCluster_BowelPrep(InputFile)

% replace with CMOST path on your folder on the Linux cluster
addpath('/cluster/home/misselwb/CMOST_BowelPrep')
try
