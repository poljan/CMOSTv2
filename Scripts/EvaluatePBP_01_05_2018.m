...
function EvaluatePBP_01_05_2018

ExcelFileName              = 'PBP_CMOST13_01052018';
...
AnalysisPipeline = '/Users/misselwb/Documents/CRC Screening/_Bowel Prep_2/Data/Data_01052018';
cd (AnalysisPipeline)
MasterDirectory=dir;
...
for x1=15:length(Headlines) % we re-assemble everything
    for x2=1:ReplicaNumber
        if isequal(x2, 1)
            ...
            R_Alive.AdvScenarioPolyp{x1}           = Alive.AdvScenarioPolyp{x1, x2}';
            ...
            R_Alive.AdvScenarioPolyp{x1}           = cat(2, R_Alive.AdvScenarioPolyp{x1}, Alive.AdvScenarioPolyp{x1, x2}');
